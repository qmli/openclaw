...
- Plugins/providers: add a bundled DeepSeek API provider (`deepseek-chat`, `deepseek-reasoner`) authenticated with `DEEPSEEK_API_KEY`, documented at `/providers/deepseek`.
